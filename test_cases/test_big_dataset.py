...
print("Big Dataset Processing Test")
print("=" * 50)
...
with open('big_dataset_vision.json', 'w') as f:
    json.dump(vision_output, f, indent=2)

print("💾 Vision results saved to big_dataset_vision.json")
...
with open('big_dataset_text.json', 'w') as f:
    json.dump(text_output, f, indent=2)

print("💾 Text results saved to big_dataset_text.json")

# Summary
print("\n" + "=" * 50)
print("🎉 BIG DATASET PROCESSING COMPLETE!")
print(f"📊 SUMMARY:")
...
print(f"   Output files: big_dataset_vision.json, big_dataset_text.json")
